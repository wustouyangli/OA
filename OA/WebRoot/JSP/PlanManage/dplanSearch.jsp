...
<html>
  <head>
    ...
    <title>My JSP 'dplanSearch.jsp' starting page</title>
  ...
  <img src="Image/return.png" style=" position: absolute;left: 10px;top: 10px;" height="30px" width="30px" onclick="history.back()"> <br>
    ...
    <table border="1" style="margin: auto;">
      ...
      <%TbDepartmentPlan m = dao.findById(idList.get(i)); %>
      <tr align="center">
        ...
        <%if (authority != null && authority.equals("admin")){ %>
        <td>
           <a href="dplandelete.action?id=<%=m.getId() %>" onclick="return DeleteConfrim()" style="color: red;">删除</a> 
           <a href="JSP/PlanManage/dplanUpdate.jsp?id=<%=m.getId() %>" style="color: red">修改</a></td>
        <%} %>
