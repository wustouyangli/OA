...
<html>
  <head>
    ...
    <title>My JSP 'dplanDetail.jsp' starting page</title>
    ...
    <style type="text/css">
      ...
      .txt{ font-size:18px; color: black;}
      .ckeDiv{ width: 80%;}
    </style>
  ...
  <img src="Image/return.png" style=" position: absolute;left: 10px;top: 10px;" height="30px" width="30px" onclick="history.back()"> <br>
    ...
    <label class="lb">部门</label><input type="text" name="department" class="txt" disabled="true" size="30" value="<%=m.getDepartment() %>"> <br>
    ...
    <label class="lb">附件</label><a href="filedownload.action?filename=<%=filename %>"><%=realname %></a> <br>
